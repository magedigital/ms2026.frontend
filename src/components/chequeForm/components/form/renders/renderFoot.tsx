...
const renderFoot: I['renderFoot'] = function () {
    ...
    return (
        <>
            <Error error={error?.text} className="chequeForm__error" callback={updateListRender} />
            <div className="chequeForm__buttons _FULL_W _ROW _ROW_CENTER">
                <div className="chequeForm__button">
                    <Button
